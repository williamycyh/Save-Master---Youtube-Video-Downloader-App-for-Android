/*
 * *
 *  * Created by Syed Usama Ahmad on 9/16/22, 8:08 PM
...
public interface RetrofitApiInterface {
    ...
    @GET
    Call<JsonObject> getInstagramData(@Url String Value, @Header("Cookie") String cookie, @Header("User-Agent") String userAgent, @Header("X-IG-App-ID") String appID);
