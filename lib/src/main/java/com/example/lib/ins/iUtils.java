...
//        Instagram 336.0.0.35.90 Android (28/9; 240dpi; 800x1280; Asus; ASUS_I005DA; ASUS_I005DA; intel; en_US; 612069221)
//        Instagram 311.0.0.32.118 Android (28/9; 240dpi; 2048x2048; Asus; ASUS_I005DA; ASUS_I005DA; intel; en_US; 545986883)

        String format_new = String.format("%s Android (%s/%s; 800x1280; %s; %s; %s; %s; %s_%s ;%s)", new Object[]{"Instagram 311.0.0.32.118", Build.VERSION.RELEASE, Build.VERSION.SDK,  Build.MODEL, Build.MANUFACTURER, Build.BRAND, Build.DEVICE, Locale.getDefault().getLanguage(), Locale.getDefault().getCountry(), 545986883});
